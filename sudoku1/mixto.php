    ...
    <head> 
        ...
        <link rel="stylesheet" href="css/mixto.css"> 
    ...
    <body> 
        ...
        <div class="contenedor"> 
            ...
            <div class="contenedor-alternativa"> 
                ...
                <div class="caja" draggable="true" ondragstart="drag(event)" id="b">20</div> 
                ...
                <div class="caja" draggable="true" ondragstart="drag(event)" id="f">3</div> 
                <div class="caja" draggable="true" ondragstart="drag(event)" id="g">0</div> 
                <div class="caja" draggable="true" ondragstart="drag(event)" id="h">6</div> 
                <div class="caja" draggable="true" ondragstart="drag(event)" id="i">5</div> 
