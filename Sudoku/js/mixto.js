    ...
    { 
        ...
        if(arreglo[0] != "" && arreglo[1] != "" && arreglo[2] != "" && arreglo[3] != "" && arreglo[4] != "" && arreglo[5] != "" && arreglo[6] != "" && arreglo[7] != "" && arreglo[8] != "") 
        { 
            //controlo si hay coincidencia 
            if(arreglo[0] == "a" || arreglo[0] == "b" || arreglo[0] == "e" && arreglo[1] == "b" || arreglo[1] == "e" || arreglo[1] == "a" && arreglo[2] == "c" && arreglo[3] == "d" && arreglo[4] == "e" || arreglo[4] == "b" || arreglo[4] == "a" && arreglo[5] == "f" && arreglo[6] == "g" && arreglo[7] == "h" && arreglo[8] == "i" ) 
            { 
